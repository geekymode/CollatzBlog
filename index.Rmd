...
```{r figWall, fig.margin = TRUE, fig.width= 8, fig.height= 8, fig.cap = "The Warsaw University Library wall featuring aspects of music (Karol Szymanowski's Etude in B minor op. 4, no. 3),culture and sciences.", message=TRUE, cache=TRUE, echo=FALSE, out.width='100%'}
