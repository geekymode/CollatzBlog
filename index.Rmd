...
[^LotharCollatz]: Lothar Collatz, among other things have played a key role in the founding of spectral graph theory. https://en.wikipedia.org/wiki/Lothar_Collatz
...
```{marginfigure, fig.cap="A quote from stackechange Greg Muller"}
